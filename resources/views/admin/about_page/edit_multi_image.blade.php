                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Edit Multi Image</a> </li>
                            </ol>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('update.multi.image') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <img id="showImage"  class="rounded avatar-lg" style="height: 288px; width: 288px;" src="{{ asset($MultiImage->multi_image) }}" alt="Card image cap">
                                            </div>
                                        </div>
                                        <br>
